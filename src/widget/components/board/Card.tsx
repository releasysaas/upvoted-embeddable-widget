...
export function Card({ feature }: { feature: IndexFeature }) {
  return (
    <a
      ...
      className="block rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-widget-input-dark p-3 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
    >
